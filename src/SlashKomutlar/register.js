...
await interaction.reply({
      embeds: [{
          ...
          color: "BLURPLE",
          footer: {text: 'Hyper Of Arsenic - Register!', iconURL: "https://cdn.discordapp.com/icons/984570471515324588/e68e1ee640b6c36865eef45ceb9f949a.png"}
      }],
      components: [row]
  })
...
user.setNickname(`${name} | ${age}`)
             await interaction.guild.members.cache.get(user.id).roles.add(manRole).then((message)=>{
                  ...
                  .setFooter({ text: `Hyper Of Arsenic - Register!`, iconURL: "https://cdn.discordapp.com/icons/984570471515324588/e68e1ee640b6c36865eef45ceb9f949a.png"})
        .setTimestamp()
                  .setColor('AQUA')
